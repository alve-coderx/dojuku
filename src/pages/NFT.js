              ...
              <div className="lg:grid grid-cols-6 lg:pt-[50px] py-10">
                <div className="lg:pt-[50px] py-5 col-start-1 col-end-4 lg:space-y-20">
                  <div className="space-y-2 lg:space-y-0">
                    <p className="text-end text-[18px] text-slate-600	 ">8887 Unique Avatars</p>
                    <p className="text-end text-[18px] text-slate-600	 ">
                      A catalogue for The Wardrobe's streetwear Doshi
                      collections{" "}
                    </p>
                    <p className="text-end text-[18px] text-slate-600	">
                    ...
                    <p className="text-end text-[18px] text-slate-600	">
                      Pair it with the apparel you buy from the The Wardrobe.
                      Only one per wallet. (Told you! Its not meant to be a
                      collectible.){" "}
                    </p>
                    <p className="text-end text-[18px] text-slate-600	">
                      A significant percentage of the fund raised goes to The
                      Dojo wallet.
                    </p>
                  </div>
