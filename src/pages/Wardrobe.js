  ...
  return (
    <div>
      <div>
        ...
        >
          ...
          <div className="container mx-auto lg:pt-[140px] py-[60px]">
            ...
            <div className="col-start-1 col-end-3">
              ...
              <div className="space-y-5 col-end-6 col-span-2  w-10/12 lg:w-12/12 mx-auto">
                <div>
                  <h1 className="text-white font-apocalypse text-[42px]">
                    Dokuji WARDROBE
                  </h1>
                  <p className="text-[#d9d9d9] text-[11px]">
                ...
                <div className="space-y-5">
                  ...
                  <p className="text-[#d9d9d9] text-[13px]">
                    ...
                    based on their attire. This is what DoKuJi Wardrobe aims to
                    do. A significant percentage of the revenue from this goes
                    to the The Dojo wallet.
                  </p>
                  <p className="text-[#d9d9d9] text-[13px]">
        ...
        >
          <div className="w-9/12 mx-auto lg:pt-[100px] py-10 space-y-10">
            <h2 className="text-white uppercase text-[20px]">
              how the wardrobe works
            </h2>
            <div className="space-y-1">
              <h3 className="text-white text-[13px]">Web3-Commerce System</h3>
              <p className="text-[#d9d9d9] text-[12px] w-10/12">
            ...
            <div className="space-y-1">
              <h3 className="text-white text-[13px]">Redeem</h3>
              <p className="text-[#d9d9d9] text-[12px] w-10/12">
